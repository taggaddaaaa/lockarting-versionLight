...
<head>
    ...
    <title>Loc'karting - Mentions Legales.</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 ml-auto mr-auto">
                        <h1 class="card-title text-center text-white" style="margin-top: 25px;">Mentions Légales</h1>
                        <div class="card card-signup">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 ml-auto mr-auto mentionsLegales">
                                        ...
                                        <p>
                                            ...
                                            portons à la connaissance des utilisateurs et visiteurs du site: <a href="/index.php">www.lockarting.fr</a> les informations
                                            suivantes :
                                        </p>
                                        ...
                                        <p>
                                            ...
                                            Adresse de courrier électronique : <strong><a href="mailto:bonjour@lockarting.fr">bonjour@lockarting.fr</a></strong> <br />
                                             <br />
                                        ...
                                        <p>
                                            Crédits : Les mentions légales ont étés générées par
                                            <strong>
                                                <a href="https://www.generer-mentions-legales.com">https://www.generer-mentions-legales.com</a>
                                            </strong>
                                        </p>
                                    </div>
                                </div>
