...
<head>
    ...
    <title>Loc'karting - Inscription à l'appli mobile.</title>
            ...
            <div class="row">
                <div class="col-sm-12 ml-auto mr-auto">
                    <div class="card card-signUp">
                        <h1 class="card-title text-center">Application pour les Pilotes <br>
                            <b style="color: red;">Loc'Karting</b>
                        </h1>
                        <p class="text-center card-subtitle">
                            Nous avons développé une application mobile rien que pour toi.
                        </p>
                        <p class="text-center card-subtitle">Elle est gratuite et
                            <strong style="color: green;">elle est bientôt prête!</strong>
                        </p>
                        <p class="text-center card-subtitle">
                            <strong style="color: green;">Inscris-toi dès maintenant</strong>
                            pour accéder à ton profil de Pilote dès la sortie de l'app dans ton store préféré.
                        </p>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 ml-auto">
                                    <div class="info info-horizontal">
                                        ...
                                        <div class="description">
                                            ...
                                            <p class="description">
                                                Retrouve tes derniers records et partage les avec tes amis.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="info info-horizontal">
                                        ...
                                        <div class="description">
                                            <h4 class="info-title">Chrono</h4>
                                            <p class="description">
                                                Suis ta progression à chacune de tes visites.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="info info-horizontal">
                                        ...
                                        <div class="description">
                                            ...
                                            <p class="description">
                                                Vérifie ton classement parmis les chronos de tous les pilotes Loc'Karting.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 mr-auto">
                                    <form name="registerForm" id="registerForm" class="form" accept-charset="UTF-8">
                                        ...
                                        <div class="form-group has-default bmd-form-group">
                                            <div class="input-group">
                                                <div class="togglebutton form-control">
                                                    <label style="color: #aaa; !important;">
                                                        <input type="checkbox"
                                                               onclick="show_element('businessInput');" >
                                                        <span class="toggle"></span>Je suis une entreprise
                                                    </label>
                                                </div>
                                                <div id="businessInput" class="input-group" style="visibility: hidden;">
                                                    <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="form-check-input"
                                                           ...
                                                           value=""
                                                           required
                                                           onclick="show_element('registerBtn');" >
                                                    <span class="form-check-sign">
                                                    <span class="check"></span>
                                                </span>
                                                    J'accepte les <a href="conditions-generales-d-utilisation.php" target="_blank">conditions générales d'utilisation</a> de l'application.
                                                </label>
                                            </div>
                                            ...
                                            <div class="text-center">
                                                <input id="registerBtn"
                                                       type="submit"
                                                       class="btn btn-xl btn-success mt-4"
                                                       value="GO !"
