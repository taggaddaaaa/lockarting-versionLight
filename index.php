...
<head>
    ...
    <script>
        ...
        fbq('init', '741751919590920');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=741751919590920&ev=PageView&noscript=1" /></noscript>
    <!-- End Facebook Pixel Code -->

    <!-- HOTJAR Tracking Code for www.lockarting.fr -->
    <script>
...
<body id="page-top">
                        ...
                        <div class="caption">
                            ...
                            <p>
                                <a href="https://www.weezevent.com/widget_billeterie.php?id_evenement=127600&amp;code=32646&amp;width_auto=1&amp;color_primary=00AEEF"
                                    onclick="var w=window.open('https://www.weezevent.com/widget_billeterie.php?id_evenement=127600&amp;code=32646&amp;width_auto=1&amp;color_primary=00AEEF', 'Billetterie_weezevent', 'width=650, height=600, top=100, left=100, toolbar=no, resizable=yes, scrollbars=yes, status=no'); w.focus(); return false;"
                                    class="btn btn-primary">Offrir !</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 hero-feature">
                    <div class="thumbnail">
                        <div class="caption">
                            ...
                            <p>Catégorie adulte à partir de 14ans. Sessions de 10 min.</p>
                            <p>
                                <a href="https://www.weezevent.com/widget_billeterie.php?id_evenement=127600&amp;code=32646&amp;width_auto=1&amp;color_primary=00AEEF"
            ...
            <div class="row">
                <div class="col-sm-4">
                    <span class="copyright">Copyright &copy;
                        <a target="_blank" href="https://www.linkedin.com/in/sabinecaizergues">Sabine Caizergues</a>
    ...
    <script>
        ...
        chatbox.setAttribute("page_id", "223079824501362");
