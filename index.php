    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li><a class="page-scroll" href="#circuit">Circuit</a></li>
...
<header id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <!-- 1st img carousel: -->
            <div class="fill" style="background-image:url(assets/img/piste3.jpg);"></div>
            <div class="carousel-caption">
                <h1>Karting de loisir tout public et entreprises</h1>
            </div>
        </div>
        <div class="item">
            <!-- 2nd img carousel: -->
            <div class="fill" style="background-image:url(assets/img/biplace3.jpg);"></div>
            <div class="carousel-caption">
                <h2>Du karting pour tous: mono-place, bi-place et handikart</h2>
            </div>
        </div>
        <div class="item">
            <!--3rd img carousel: -->
            <div class="fill" style="background-image:url(assets/img/Karting_24.jpg);"></div>
            <div class="carousel-caption">
                <h2>Du karting, comme les grands, dès 7 ans</h2>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row text-center">
            <div class="col-md-4">
                ...
                <p class="text-muted">
                    700 mètres d'asphalte, deux épingles, sept virages, une ligne droite. Dix minutes
                    de course effreinée!
                </p>
            </div>
            ...
            <div class="col-md-4">
                ...
                <p class="text-muted">
                    Notre parc de karting est révisé tous les jours par notre mécanicien. Le 160cc
                    Mini kart est pour les enfants jusqu'à 13 ans et le 270cc Elite pour les adultes. Nous avons aussi
                    un karting bi-places pour initier les plus jeunes aux joies de la piste, accompagnés d'un
                    adulte.
                </p>
            </div>
            ...
            <div class="col-md-4">
                ...
                <p class="text-muted">
                    Une équipe professionnelle et souriante pour une expérience détendue en toute
                    sécurité. Que vous soyez débutant, professionnel, timide ou pilote émérite, l'équipe s'adapte pour
                    que chaque visite soit une excellente sortie!
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <!--<h3 class="section-subheading" style="color: red;">
                FERMETURE ANNUELLE : Le circuit est fermé tout le mois de janvier
                et n'ouvrira que le 04 février 2017 à 14h00! MERCI À TOUS ET BONNE ANNÉE
                </h3>-->
            </div>
        </div>

        <div class="row">
            <div class="col-md-4 col-sm-6 infos-item">
                <a href="#infosModal1" class="infos-link" data-toggle="modal">
            ...
            <div class="col-md-4 col-sm-6 infos-item">
                <a href="#infosModal2" class="infos-link" data-toggle="modal">
                    <div class="infos-hover">
                        <div class="infos-hover-content"><i class="fa fa-plus fa-3x"></i></div>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 infos-item">
                <a href="#infosModal3" class="infos-link" data-toggle="modal">
                    <div class="infos-hover">
                        <div class="infos-hover-content"><i class="fa fa-plus fa-3x"></i></div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">Offrez du karting!</h3>
            </div>
        </div>
        ...
        <div class="row text-center">
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    <div class="caption">
                        <h3>Billeterie Kart Mini 160cc</h3>
                        <p>Catégorie enfant de 7 à 13 ans. Session de 10 min.</p>
                        <p>
                            <a href="https://www.weezevent.com/widget_billeterie.php?id_evenement=127600&amp;code=32646&amp;width_auto=1&amp;color_primary=00AEEF"
                               onclick="let w=window.open('https://www.weezevent.com/widget_billeterie.php?id_evenement=127600&amp;code=32646&amp;width_auto=1&amp;color_primary=00AEEF', 'Billetterie_weezevent', 'width=650, height=600, top=100, left=100, toolbar=no, resizable=yes, scrollbars=yes, status=no'); w.focus(); return false;"
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    <div class="caption">
                        <h3>Billeterie Kart Bi-place</h3>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center">
                <p class="large text-muted">
                    Pour se faire plaisir ou faire plaisir à quelqu'un, nous avons mis en place la vente en ligne
                    de nos tickets.
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">
                    Pour des informations complémentaires, une réservation, un devis, une suggestion,
                        ...
                        <div class="col-md-6 control-group">
                            ...
                            <div class="form-group">
                                <input type="tel"
                                       ...
                                       required
                                       maxlength="10"
                                       data-validation-tel-regex="([0-9]*)"
                                       data-validation-tel-message="S'il vous plait, entrez un numéro de téléphone valide."
                                >
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <p style="text-align: justify;">
                            ...
                            portons à la connaissance des utilisateurs et visiteurs du site: <a
                                href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a> les informations
                            suivantes :
                        </p>
                        <p style="text-align: justify;">
                        ...
                        <p style="text-align: justify;">
                            ...
                            <br/>
                            L?utilisation du site <a href="https://www.lockarting.fr"
                            ...
                            aussi les utilisateurs du site <a href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a>
                            sont  invités à les consulter de manière régulière.<br/>
                            <a href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a> est par principe
                            ...
                            service, <a href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a> s?engage à
                            ...
                            une obligation de moyen, <a href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a>
                        ...
                        <p style="text-align: justify;">
                            Le site <a href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a> est mis à
                            ...
                            Le site <a href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a> se réserve
                            ...
                            présentes CGU et mentions légales. En continuant à utiliser les services du site <a
                                href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a> , l?utilisateur
                        ...
                        <p style="text-align: justify;">
                            ...
                            <br/>
                            Le site <a href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a> a pour
                            objet de fournir une information concernant l?ensemble des activités de la société.<br/>
                            Le propriétaire du site s?efforce de fournir sur le site <a href="https://www.lockarting.fr"
                            ...
                            Tous les informations proposées sur le site <a href="https://www.lockarting.fr"
                        ...
                        <p style="text-align: justify;">
                            ...
                            <br/>
                            Le site <a href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a> utilise la
                            technologie java script.<br/>
                            Le site <a href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a> ne saurait
                            ...
                            <br/>
                            L?utilisateur du site <a href="https://www.lockarting.fr"
                            ...
                            <br/>
                            L?utilisateur dégage la responsabilité de <a href="https://www.lockarting.fr"
                            ...
                            service proposé et celui-ci dégage expressément le site <a href="https://www.lockarting.fr"
                                                                                       target="_blank">www.lockarting.fr</a>
                            ...
                            disposition des utilisateurs. Le site <a href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a>
                            ...
                            Il est ici rappelé que les développeurs du site <a href="https://www.lockarting.fr"
                                                                               target="_blank">www.lockarting.fr</a>
                        ...
                        <p style="text-align: justify;">
                            ...
                            <br/>
                            Le site <a href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a> contient un
                            ...
                            L?utilisateur est informé que lors de ses visites sur le site <a
                                href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a>, un ou des cookies
                        ...
                        <p style="text-align: justify;">
                            ...
                            <br/>
                            <br/>
                            Tout litige en relation avec l?utilisation du site <a href="https://www.lockarting.fr"
                                                                                  target="_blank">www.lockarting.fr</a>
                            est soumis au droit français. L?utilisateur ainsi que <a href="https://www.lockarting.fr"
                                                                                     target="_blank">www.lockarting.fr</a>
                        ...
                        <p style="text-align: justify;">
                            ...
                            Utilisateur : Internaute se connectant, utilisant le site susnommé : <a
                                href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a><br/>
                        ...
                        <p style="text-align: justify;">
                            Sur le site <a href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a>, le
                            propriétaire du site ne collecte des informations personnelles relatives à l'utilisateur que
                            pour le besoin de certains services proposés par le site <a href="https://www.lockarting.fr"
                                                                                        target="_blank">www.lockarting.fr</a>.
                            ...
                            procède par lui-même à leur saisie. Il est alors précisé à l'utilisateur du site <a
                                href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a> l?obligation ou
                            ...
                            concernant. Pour l?exercer, adressez votre demande à <a href="https://www.lockarting.fr"
                                                                                    target="_blank">www.lockarting.fr</a>
                        ...
                        <p style="text-align: justify;">
                            Aucune information personnelle de l'utilisateur du site <a href="https://www.lockarting.fr"
                                                                                       target="_blank">www.lockarting.fr</a>
                            ...
                            support quelconque à des tiers. Seule l'hypothèse du rachat du site <a
                                href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a> au propriétaire du
                            ...
                            modification des données vis-à-vis de l'utilisateur du site <a
                                href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a>.<br/>
                            Le site <a href="https://www.lockarting.fr" target="_blank">www.lockarting.fr</a> est déclaré
